...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
    if ([call.method isEqualToString:kBMFPoiDetailShareURLMethod]) {
        ...
        Id = [[call.arguments safeObjectForKey:@"poiDetailShareURLOption"] safeObjectForKey:@"id"];
        ...
        Id = [[call.arguments safeObjectForKey:@"reverseGeoShareURLOption"] safeObjectForKey:@"id"];
        ...
        Id = [[call.arguments safeObjectForKey:@"routePlanShareURLOption"] safeObjectForKey:@"id"];
